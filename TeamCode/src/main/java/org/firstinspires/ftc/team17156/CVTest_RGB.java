...
public class CVTest_RGB extends LinearOpMode
{
    final static boolean isUsingWebcam = false; // Remember to change it
    ...
    public void runOpMode()
    {
         ...
         */
        camera.setPipeline(detector = new RingDetector());
